...
<head>
  ...
  // 若未GET顯示頁面
  if(!(isset($_GET['show']))){
    die ('<meta http-equiv="refresh" content="0;URL=cash_list.php?show=list&page=0">');
  }else{
  ...
  <div class="container mt-3">
    ...
    <div class="row">
      <div class="col-12 btn-group">
        ...
        <button class="btn btn-outline-primary btn-lg <?php if($_GET['show']=='new')echo 'active '?>" onclick="location.href='?show=new'">我要提款</button>
      </div>
      <!-- 管理商品 -->
